 ...
 * @method static Builder|Invoice whereParentId($value)
  * @method static Builder|Invoice whereExchangeRate($value) // <--- ADDED: PHPDoc for new column
 */
class Invoice extends Model
{
    ...
    public $fillable = [
        ...
        'last_recurring_on',
        'parent_id',
        'exchange_rate', // <--- ADDED: To allow mass assignment
        'exchange_currency', // <--- ADDED: To allow mass assignment
        'exchange_rate_to_riel', // <--- ADDED: To allow mass assignment
        'vat_tin', // <--- ADDED: To allow mass assignment
    ];
    ...
    protected $casts = [
        ...
        'tax' => 'double',
        'exchange_rate' => 'float', // <--- ADDED: To cast the column to a float
        'exchange_currency' => 'string', // <--- ADDED: To cast the column to a string
        'exchange_rate_to_riel' => 'float', // <--- ADDED: To
        'vat_tin' => 'string', // <--- ADDED: cast vat_tin as string
