    ...
    public function index(Request $request): View|Factory|Application
{
    ...
    // ✅ Fetch invoices only for the logged-in client, filtered by status if needed
    $invoices = Invoice::query()
        ->where('client_id', auth()->user()->id) // ← FILTER HERE
    ...
    return view('invoices.index', compact('statusArr', 'status', 'invoices'));
}
    ...
    $data = DB::table('invoices')
        ...
        ->select(
            ...
            'invoices.due_date',
            'invoices.amount',
            'invoices.exchange_rate_to_riel as exchange_rate',
            'invoices.final_amount',
            'invoices.status',
            'invoices.vat_tin', // Assuming you want to include VAT
    ...
    return view('invoices.invoice_template_pdf.defaultTemplate', compact('data'));
}
...
public function showInvoice($invoiceId)
{
    ...
    ->select(
        ...
        'invoices.final_amount',
        'invoices.status',
        'invoices.exchange_rate_to_riel as exchange_rate', // Assuming you want to include exchange rate
        'invoices.exchange_currency',
        'invoices.vat_tin', // Assuming you want to include VAT
