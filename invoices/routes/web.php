...
use App\Http\Controllers\ExcelInvoiceController;
use App\Http\Controllers\ExcelQuoteController;
...
Route::middleware(['xss'])->group(function () {
    ...
    Route::get(
     ...
     Route::get(
        'invoice-pdf/{invoice}',
        [InvoiceController::class, 'getOfficialReceiptPdf']
    )->name('public-view-invoice.pdf');
...
Route::prefix('admin')->middleware(['auth', 'xss', 'role:admin'])->group(function () {
    ...
    Route::get('generate-recurring-quote', function () {
        Artisan::call('in:create-recurring-quote');
    });
    ...
    Route::get('convert-to-invoice', [QuoteController::class, 'convertToquotes'])->name('quotes.convert-to-invoice');
    ...
    Route::get('template-setting', [OfficialReceiptController::class, 'invoiceTemplateView'])->name('invoiceTemplate');

     Route::post(
        'change-invoice-template',
        [OfficialReceiptController::class, 'invoiceTemplateUpdate']
...
Route::get('/invoices/{invoice}/official-receipt-pdf', [OfficialReceiptController::class, 'showInvoice'])
    ->name('invoices.invoice_template_pdf.OfficialReceipt');
  ...
  Route::get('invoice/export/excel/{invoiceId}', [ExcelInvoiceController::class, 'exportInvoiceExcel'])
...
Route::get('/quotes/export-excel/{quoteId}', [ExcelQuoteController::class, 'exportQuotation'])
    ->name('quotes.export.excel');
...
Route::get('/invoice/{invoiceId}', [InvoiceTemplateController::class, 'showInvoice'])
    ->name('invoice.invoice_template_pdf.GG');
