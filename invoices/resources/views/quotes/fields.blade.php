...
<div class="row">
    ...
    <div class="mb-0">
        <div class="col-12 text-end mb-lg-6 mb-6">
            ...
            <table class="table table-striped box-shadow-none mt-4" id="billTbl">
                ...
                <tbody class="quote-item-container">
                    <tr class="tax-tr">
                        ...
                        {{-- <td class="table__product_desc">
                            {{ Form::textarea('description[]', null, ['class' => 'form-control product-desc-quote', 'rows' => 1, 'onKeyPress' => 'if(this.value.length==100) return false;']) }}
                        </td>


                        <td class="table_product_rate">
                            {{ Form::text('rate[]', null, [
                                'class' => 'form-control rate-quote',
