...
<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-4">
        ...
        <div class="input-group mb-5">
            {{ Form::text('name', old('name', $product->name ?? ''), [
                'class' => 'form-control',
                'placeholder' => __('messages.product.name'),
                'required',
    ...
    <div class="col-lg-4">
        ...
        <div class="input-group mb-5">
            {{ Form::text('code', old('code', $product->code ?? ''), [
                'class' => 'form-control',
    ...
    <div class="col-lg-4">
        <div class="mb-5">
            ...
            {{ Form::select('category_id', $categories, old('category_id', $product->category_id ?? ''), [
                ...
                'placeholder' => __('messages.product.category'),
                'required',
    ...
    <div class="col-lg-4">
        <div class="mb-5">
            ...
            {{ Form::number('unit_price', old('unit_price', $product->unit_price ?? ''), [
                'id' => 'unitPriceId',
                'class' => 'form-control',
    ...
    <div class="col-lg-4">
        <div class="mb-5">
            {{ Form::label('description', __('messages.product.rate') . ':', ['class' => 'form-label mb-3']) }}
            {{ Form::textarea('description', old('description', $product->description ?? ''), [
                'class' => 'form-control',
                'placeholder' => __('messages.product.rate'),
                'rows' => 5
            ]) }}
        </div>
    </div>
    ...
    {{-- <div class="col-lg-4">
        <div class="mb-5">
            {{ Form::label('rate', __('messages.product.rate') . ':', ['class' => 'form-label mb-3']) }}
            {{ Form::textarea('rate', old('rate', $product->rate ?? ''), [
                'class' => 'form-control',
                'placeholder' => __('messages.product.rate'),
                'rows' => 5
            ]) }}
            ...
            <div class="d-block">
                <div class="image-picker">
                    <div class="image previewImage" id="previewImage"
                        style="background-image: url('{{ !empty($product->product_image) ? $product->product_image : asset('images/default-product.jpg') }}')">
                    </div>
