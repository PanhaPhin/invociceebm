<div class="dropup position-static" wire:key="{{ $row->id }}">
    ...
    <a class="px-2" href="{{ route('invoices.pdf', $row->id) }}"  target="_blank"><i  class="fa-solid fa-download fs-2"></i></a>
   ...
   <a href="{{ route('invoice.export.excel', $row->invoice_id) }}" class="btn btn-success" target="_blank">
    Export to Excel
</a>
