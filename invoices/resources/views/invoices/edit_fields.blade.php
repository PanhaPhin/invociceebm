...
@php
    // Removed 'use' statement; ensure Form alias is available globally or use full class name below if needed.
@endphp
...
<div class="row mb-2">
    ...
    {{-- --- ADD THIS BLOCK FOR EXCHANGE RATE --- --}}
    <div class="col-lg-3 col-sm-12 mb-5">
        {{-- Label: "Exchange Rate (USD to KHR)" --}}
        {{ Form::label('exchange_rate', __('messages.invoice.exchange_rate_usd_khr') . ':', ['class' => 'form-label required mb-3']) }}

        <div class="input-group">
            <span class="input-group-text">1 USD =</span>
            {{-- For edit form, use $invoice->exchange_rate --}}
            {{ Form::number('exchange_rate', $invoice->exchange_rate, ['class' => 'form-control', 'id' => 'exchange_rate', 'step' => 'any', 'required']) }}
            <span class="input-group-text">KHR</span>
        </div>
    </div>

    <div class="col-lg-3 col-sm-12 mb-5">
    {{ Form::label('vat_tin', __('messages.invoice.vat_tin') . ':', ['class' => 'form-label required mb-3']) }}

    <div class="input-group">
        <span class="input-group-text">VAT/TIN</span>
        {{ Form::text('vat_tin', $invoice->vat_tin, ['class' => 'form-control', 'id' => 'vatTin', 'autocomplete' => 'off']) }}
    </div>
</div>
