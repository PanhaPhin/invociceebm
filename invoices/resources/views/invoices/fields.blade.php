...
<div class="row">
    ...
    <div class="col-lg-4 col-sm-12 mb-5">
    {{-- Label with proper "for" attribute linked to input id --}}
    {{ Form::label('exchange_rate', __('messages.invoice.exchange_rate_usd_khr') . ':', [
        'class' => 'form-label required mb-3',
        'for' => 'exchange_rate'
    ]) }}

    <div class="input-group mb-3">
        <span class="input-group-text" id="exchangeRateAddon">1 USD =</span>

        {!! Form::number('exchange_rate', old('exchange_rate', $invoice->exchange_rate ?? $currentExchangeRate ?? 4000), [
            'class' => 'form-control',
            'id' => 'exchange_rate',
            'step' => 'any',
            'required' => true,
            'aria-describedby' => 'exchangeRateAddon',
            'min' => 1, // prevent invalid low numbers
    ...
    <div class="col-lg-4 col-sm-12 mb-5">
        {{ Form::label('vat_tin', __('messages.invoice.vat_tin') . ':', ['class' => 'form-label mb-3']) }}
        {{ Form::text('vat_tin', null, ['class' => 'form-control', 'id' => 'vatTin']) }}
    ...
    <div class="col-lg-4 col-sm-12">
        {{  Form::label('description',__('messages.product.description') . ':' , ['class' => 'form-label required mb-3']) }}
        {{ Form::textarea('description', null, ['class' => 'form-control', 'id' => 'description', 'rows' => '3', 'required']) }}
    </div>
