        ...
        ,['class' => 'form-control form-control-solid form-select', 'data-control'=>"select2", 'id' => 'invoiceStatus']) !!}
                    ...
                    <div class="mb-5">
                        <label for="filterBtn"
                            ...
                            :</label>
                        {!! Form::select('recurring_status', collect($filterHeads[1])->sortBy('key')->reverse()->toArray(), null
        ,['class' => 'form-control form-control-solid form-select', 'data-control'=>"select2", 'id' => 'recurringStatus','placeholder' => 'All']) !!}
                    </div>
