<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            {{ Form::label('vattin', __('messages.client.vattin').':', ['class' => 'form-label  mb-3 required']) }}
            {{ Form::text('vattin',null, ['class' => 'form-control', 'placeholder' =>  __('messages.client.vattin'), 'required', 'maxlength' => 20]) }}
        </div>
    </div>
    <div class="col-lg-4">
        <div class="mb-5">
