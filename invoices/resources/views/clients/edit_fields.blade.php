<div class="row gx-10 mb-5">
    ...
    <div class="col-lg-6">
        <div class="mb-5">
            {{ Form::label('vattin', __('messages.client.vattin').':', ['class' => 'form-label required mb-3']) }}
            {{ Form::text('vattin',$client->postal_code ?? null, ['class' => 'form-control form-control-solid', 'placeholder' => __('messages.client.vattin'), 'required', 'maxlength' => 20]) }}
        </div>
    </div>
    <div class="col-lg-4">
        <div class="mb-5">
